...
_hpux,1,
  [define(declare_getenv,[
      EXTERNAL GETENV_])dnl
define(declare_isatty,[INTEGER [ISATTY]
      EXTERNAL [ISATTY]])],
_AIX,1,
  [define(declare_getenv,[
      INTRINSIC GETENV])dnl
define(declare_isatty,[INTEGER [ISATTY]
      EXTERNAL [ISATTY]])],
dnl
  [define(declare_getenv,[
      EXTERNAL GETENV])dnl
define(declare_isatty,[LOGICAL [ISATTY]
      EXTERNAL [ISATTY]])])dnl
C
