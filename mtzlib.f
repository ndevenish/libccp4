...
C     .. Parameters ..
      ...
      PARAMETER (MFILES=4,MCOLS=500,MBATCH=5000,MFILEX=9)
C
      INTEGER MBLENG
...
C     .. Parameters ..
      ...
      PARAMETER (MFILES=4,MCOLS=500,MBATCH=5000)
      INTEGER MBLENG
      PARAMETER (MBLENG=185)
      INTEGER MAXSYM
      PARAMETER (MAXSYM=192)
...
C     .. Local Arrays ..
      REAL FVALUE(MAXTOK)
      INTEGER IBEG(MAXTOK),IDEC(MAXTOK),IEND(MAXTOK),ITYP(MAXTOK)
      CHARACTER CTYPES(NTYP)*1,LTYPES(LTYP)*1,CVALUE(MAXTOK)*4
C     ..
C     .. External Functions ..
      INTEGER LENSTR
      EXTERNAL LENSTR
...
C              ***********************
          ...
          CALL BLANK('CURWIN',1)
          WRITE (STROUT,FMT='(6F10.4)') (CELL(JJ,MINDX),JJ=1,6)
          CALL PUTLIN(STROUT,'CURWIN')
          CALL BLANK('CURWIN',1)
C              ***********************
C
