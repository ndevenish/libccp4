...
C
C
cc-iris #include "fgl.h"
cc-iris #include "fdevice.h"
         include 'fgl.h'
         include 'fdevice.h'
C
C
...
c
           IF (VMSVAX) THEN
            WRITE(12,6000) ESC,SUB
            ELSE
            WRITE (12,FMT=6001) ESC,SUB
            END IF
6000        FORMAT ('+',2A,$)
6001        FORMAT (2A,$)
6002        FORMAT (6A)
99      continue
             IF (VMSVAX) THEN
      READ (12,FMT=6002) (VSTRING(J),J=1,6)
      CALL TKDECODEV(VSTRING(2),IY,IX)
      cha=bstring
            else
...
C
      IF (VMSVAX) THEN
      CALL TKENCODEV(JX,JY,VSTRING)
      WRITE (12,FMT=6000) (VSTRING)
      ELSE
