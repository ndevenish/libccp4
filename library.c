#line 87 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 143 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if F2C
/* #  define KNOWN_MACHINE */
#  define CALL_LIKE_SUN 1
#line 151 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#else
#if defined (_AIX)
#  define KNOWN_MACHINE
#  define CALL_LIKE_HPUX 1
#endif
#line 158 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if defined (alliant)
#  define KNOWN_MACHINE
#  define CALL_LIKE_SUN 1
#endif
#line 165 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#endif
#line 180 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if defined (__convex__) || defined (__convexc__)
#  define KNOWN_MACHINE
#  define CALL_LIKE_SUN 1
#endif
#line 189 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if defined (ESV)
#  define KNOWN_MACHINE
#  define CALL_LIKE_SUN 1
#endif
#line 196 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if defined (__hpux) 
#  define KNOWN_MACHINE
#  define CALL_LIKE_HPUX 1
#endif
#line 203 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if defined (iris)
#  define KNOWN_MACHINE
#  define CALL_LIKE_IRIS 1
#endif
#line 212 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#  define CALL_LIKE_SUN 1
#endif
#line 223 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if defined (solbourne) 
#  ifndef sun
#   define sun               /* don't know whether it's defined or not */
#  endif
#endif
#line 230 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if defined (sun)
#  define KNOWN_MACHINE
#  define CALL_LIKE_SUN 1
#  ifndef __STDC__
...
#  endif
#endif
#line 242 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#define COMP32  3
#define COMP64  4
#line 1489 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#  define NATIVEIT DFNTI_IBO
#endif
#line 1544 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#endif
#line 1551 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if defined(__convex__) || defined(__convexc__)
#  define NATIVEIT DFNTI_MBO
#  ifdef _IEEE_FLOAT_
#    define NATIVEFT DFNTF_BEIEEE
...
#endif
#line 1573 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1582 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 391 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 405 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 424 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1588 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 438 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1679 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1722 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1774 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1817 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 505 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if ! defined (VMS)
#line 509 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
#line 507 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#endif
#line 570 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
#line 622 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
#line 713 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#ifdef VMS
...
#line 1211 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if defined (__alpha) && defined (vms)
(void) fflush (file_stream[*iunit]);
#endif
#line 732 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
  if (fseek (file_stream[*iunit], 0L, SEEK_SET) != 0)
    fatal("(Q)QOPEN: fseek failed");
  *iunit = i;
}
#line 772 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 810 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 841 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 860 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
  if (fseek (file_stream[*iunit], (size_t) ((*ipos)*item_sizes[2]),
             SEEK_SET) != 0)
...
#line 876 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
  void qclose (iunit)
#endif
...
#line 908 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
#line 944 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 966 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 988 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1601 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
{
...
#line 994 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
    break;
  case INT32:
    if (Iconvert[*iunit])
...
#line 1662 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
{
  char j;
  for (i=0; i < n*4; i+=4) {
    j = buffer[i];
...
#line 1617 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
else
  fatal("QREAD: bad file integer type in conversion");
}
...
#line 1624 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
{
...
#line 1636 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
     break;
   default :
     fatal("QREAD: bad file real type in conversion");
   }
#line 1645 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
switch (nativeFT) {
  case DFNTF_BEIEEE :
    break;                      /* done enough */
  case DFNTF_LEIEEE :
...
#line 1650 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
    break;
  case DFNTF_CONVEXNATIVE :
...
#line 1002 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
    break;
  case COMP32:
    if (Fconvert[*iunit]) {
      n = 2*n;                  /* pairs of ints */
...
#line 1013 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
    }
    break;
  default:
    fatal ("QREAD: Bad mode");
  }
#line 985 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
}
#line 1027 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 1053 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
    if (fseek (file_stream[*iunit], 0L, SEEK_CUR) != 0) {
      *result = -1;
      return; } }
  file_last_op[*iunit] = READ_OP;
...
#line 1076 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 1097 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
    if (fseek (file_stream[*iunit], 0L, SEEK_CUR) != 0)
...
#line 1109 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 1134 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
    if (fseek (file_stream[*iunit], 0L, SEEK_CUR) != 0)
      fatal ("QWRITE: i/o error"); }
  file_last_op[*iunit] = WRITE_OP;
#if defined (VMS) || defined (ardent) || defined (titan) || defined (stardent)
...
#line 1151 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 1174 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
  if (fseek (file_stream[*iunit],position,SEEK_SET) != 0)
    fatal ("QSEEK failed");     /* fixme: add file info */
}
#line 1181 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 1203 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
  if (fseek (file_stream[*iunit], position, SEEK_SET) != 0)
    fatal ("QBACK failed");     /* fixme: add file info */
}
#line 1217 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 1240 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
  if (fseek (file_stream[*iunit],position,SEEK_SET) != 0)
    fatal ("QSKIP failed");     /* fixme: add file info */
}
#line 1249 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 1315 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1325 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
#line 1352 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#ifdef _AIX
void idate (d, m, y)
     int *y, *m, *d;
{
...
#endif  /* AIX || HPUX */
#line 1916 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
  float qnan ()
#endif
#if defined (VMS) || CALL_LIKE_STARDENT
  ...
  float qnan_ ()
#endif
#line 1931 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#endif
#line 1940 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1964 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
  int cisnan (real)
#endif
#if defined (VMS) || CALL_LIKE_STARDENT
...
#line 1984 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
switch (nativeFT) {
 case DFNTF_BEIEEE :
 ...
 case DFNTF_LEIEEE :
   return (((real.i & 0x0000807f)
           ...
           && ((real.i & 0xffff7f00)
               == 0));          /* non-zero fraction */
#line 1999 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
  case DFNTF_CONVEXNATIVE :
...
#line 1979 "/ccpdisk/xtal/ccp4/lib/src/library.nw"
}
