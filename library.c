...
#  define CALL_LIKE_SUN 1
#endif
#line 251 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#ifndef VMS
...
#endif
#endif /* F2C */
#line 266 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if ! defined (KNOWN_MACHINE)
  #error System type is not known -- see the Installation Guide
#else
#line 288 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#ifndef _POSIX_SOURCE
#define _POSIX_SOURCE
#endif
#line 292 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#include <stdio.h>
...
#  include <stddef.h>
#endif
#line 311 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#include <string.h>
#line 315 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#ifndef NOUNISTD
#  include <unistd.h>
#else
#  ifndef VMS
...
#  include <time.h>
#endif
#line 336 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 342 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#define IRRELEVANT_OP   0
#define READ_OP         1
#define WRITE_OP        2
#line 351 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#ifndef SEEK_SET
#  define SEEK_SET 0
#  define SEEK_CUR 1
#  define SEEK_END 2
#endif /* ! SEEK_SET */
#line 357 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#endif
#line 370 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#define BYTE  0
#define INT16 1   
#define INT32 6
#define FLOAT32 2
#define COMP32  3
#define COMP64  4
#line 1524 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#  define NATIVEIT DFNTI_IBO
#endif
#line 1579 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#endif
#line 1586 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if defined(__convex__) || defined(__convexc__)
#  define NATIVEIT DFNTI_MBO
#  ifdef _IEEE_FLOAT_
#    define NATIVEFT DFNTF_BEIEEE
...
#endif
#line 1608 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1617 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
typedef unsigned short uint16;
typedef unsigned long uint32;
typedef float float32;
typedef unsigned char uint8;
#line 380 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
static char rcsid[] = "$Id$";
static int initialised =  0;    /* flag to initialise data and file streams */
#line 393 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if defined (__DECC)
...
#line 416 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 435 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1602 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
static uint16 nativeIT = NATIVEIT; /* machine integer type */ 
static uint16 nativeFT = NATIVEFT; /* machine float type */
#line 1623 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 449 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 460 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1714 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1757 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1809 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1852 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 517 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if ! defined (VMS)
#line 521 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
#line 519 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#endif
#line 582 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
#line 2055 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#endif /* VMS */
#line 634 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
#line 725 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#ifdef VMS
...
#line 1246 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if defined (__alpha) && defined (vms)
(void) fflush (file_stream[*iunit]);
#endif
#line 744 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
  if (fseek (file_stream[*iunit], 0L, SEEK_SET) != 0)
    fatal("(Q)QOPEN: fseek failed");
  *iunit = i;
}
#line 784 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 822 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 853 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 872 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
  if (fseek (file_stream[*iunit], (size_t) ((*ipos)*item_sizes[2]),
             SEEK_SET) != 0)
...
#line 888 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
  void qclose (iunit)
#endif
#if defined (VMS) || CALL_LIKE_STARDENT
...
#line 920 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
#line 956 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 978 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1000 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1636 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
{
...
#line 1006 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
    break;
  case INT32:
    if (Iconvert[*iunit])
      
#line 1648 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
{
if ((Iconvert[*iunit]==DFNTI_MBO && nativeIT==DFNTI_IBO) ||
    (Iconvert[*iunit]==DFNTI_IBO && nativeIT==DFNTI_MBO))
  
#line 1697 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
{
  char j;
  for (i=0; i < n*4; i+=4) {
    j = buffer[i];
...
#line 1652 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
else
  fatal("QREAD: bad file integer type in conversion");
}
#line 1010 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
    break;
  case FLOAT32:
    if (Fconvert[*iunit])
      
#line 1659 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
{
...
#line 1671 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
     break;
   default :
     fatal("QREAD: bad file real type in conversion");
   }
#line 1680 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
switch (nativeFT) {
  case DFNTF_BEIEEE :
    break;                      /* done enough */
  case DFNTF_LEIEEE :
...
#line 1014 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
    break;
  case COMP32:
    if (Fconvert[*iunit]) {
      n = 2*n;                  /* pairs of ints */
...
#line 1019 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
    }
    break;
  case COMP64:
    if (Fconvert[*iunit]) {
...
#line 1025 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
    }
    break;
  default:
    fatal ("QREAD: Bad mode");
  }
#line 997 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
}
#line 1039 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 1067 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
    if (fseek (file_stream[*iunit], 0L, SEEK_CUR) != 0) {
      *result = -1;
      return; } }
  file_last_op[*iunit] = READ_OP;
...
#line 1099 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 1120 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
    if (fseek (file_stream[*iunit], 0L, SEEK_CUR) != 0)
...
#line 1133 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 1160 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
    if (fseek (file_stream[*iunit], 0L, SEEK_CUR) != 0)
      fatal ("QWRITC: i/o error"); }
  file_last_op[*iunit] = WRITE_OP;
#if defined (VMS)
  n = buffer->dsc$w_length;
...
#  endif
  ...
  i = (int) fwrite (buffer, (size_t) item_sizes[BYTE],
                    (size_t) n, file_stream[*iunit]);
  if (i != n) fatal ("QWRITC: i/o error");
}
#line 1186 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 1209 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
  if (fseek (file_stream[*iunit],position,SEEK_SET) != 0)
    fatal ("QSEEK failed");     /* fixme: add file info */
}
#line 1216 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 1238 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
  if (fseek (file_stream[*iunit], position, SEEK_SET) != 0)
    fatal ("QBACK failed");     /* fixme: add file info */
}
#line 1252 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 1275 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
  if (fseek (file_stream[*iunit],position,SEEK_SET) != 0)
    fatal ("QSKIP failed");     /* fixme: add file info */
}
#line 1284 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
(void) fflush (file_stream[*iunit]);
#endif
#line 1350 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1360 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
...
#line 1387 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#ifdef _AIX
void idate (d, m, y)
     int *y, *m, *d;
{
...
#endif
#line 1399 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#endif  /* AIX || HPUX */
#line 1949 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
  void cnan (real)
#endif
#if defined (VMS) || CALL_LIKE_STARDENT
...
#line 1965 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if NATIVEFT == DFNTF_BEIEEE || NATIVEFT == DFNTF_LEIEEE
#  define NAN 0xfffa5a5a
#endif
#line 1971 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
...
#line 1992 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#if CALL_LIKE_HPUX
  int cisnan (real)
#endif
#if defined (VMS) || CALL_LIKE_STARDENT
...
#line 2015 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
switch (nativeFT) {
 case DFNTF_BEIEEE :
 case DFNTF_LEIEEE :
   return ((real->i & 0x7f800000) == 0x7f800000); /* exponent all 1s */
#line 2023 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
  case DFNTF_CONVEXNATIVE :
...
#line 2007 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
}
#line 270 "/nfs/dlpx1/ccpdisk/xtal/ccp4/lib/src/library.nw"
#endif
